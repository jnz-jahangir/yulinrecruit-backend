...
class Game(WithGameLifecycle):
    def __init__(self,
        ...
        self.boards: Dict[str, Board] = {
            'score_newbie': ScoreBoard('新生排名', None, self, UserStore.MAIN_BOARD_GROUPS, False, 100),
            'first_newbie': FirstBloodBoard('新生一血榜', None, self, UserStore.MAIN_BOARD_GROUPS, False),
            'score_all': ScoreBoard('总排名', '只有用户组为 “新生” 的用户参与招新', self, UserStore.TOT_BOARD_GROUPS, True, 150),
